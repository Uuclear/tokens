...
pub fn logo_bytes(platform_id: &str) -> Option<(&'static str, &'static [u8])> {
    match platform_id {
        ...
        "hermes" => Some(("image/png", include_bytes!("assets/logos/hermes.png"))),
        "qwen_code" => Some(("image/png", include_bytes!("assets/logos/qwen_code.png"))),
        "pi" => Some(("image/png", include_bytes!("assets/logos/pi.png"))),
        ...
        "chatbox" => Some(("image/png", include_bytes!("assets/logos/chatbox.png"))),
        "qoder" => Some(("image/png", include_bytes!("assets/logos/qoder.png"))),
        "qoder_cn" => Some(("image/png", include_bytes!("assets/logos/qoder_cn.png"))),
        "postman" => Some(("image/png", include_bytes!("assets/logos/postman.png"))),
